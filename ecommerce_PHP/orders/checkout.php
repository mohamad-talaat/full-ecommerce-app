...
// Convert string values to float/integer for calculations
$pricedelivery = floatval($pricedelivery);
$ordersprice = floatval($ordersprice);
$coupondiscount = floatval($coupondiscount);

// Set delivery price to 0 for pickup orders (type 1)
if ($orderstype == "1") {
    $pricedelivery = 0;
}
