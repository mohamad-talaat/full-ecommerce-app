...
// function checkAuthenticate()  // it is a function to check if the user is authenticated or not<< instead of Token authentication
// {
...
//    $header = "From: support@waelabohamza.com " . "\n" . "CC: waeleagle1243@gmail.com";
    $header = "From: motalaat1610@gmail.com  " . "\n" . "CC: motalaat1610@gmail.com ";
